...
public class TrappedCommand extends GriefPreventionCommand {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		// FEATURE: empower players who get "stuck" in an area where they don't
		// have permission to build to save themselves
		...
		// if the player isn't in a claim or has permission to build, tell him
		// to man up
		...
		// if the player is in the nether or end, he's screwed (there's no way
		// to programmatically find a safe place for him)
		...
		inst.getServer().getScheduler().scheduleSyncDelayedTask(inst, task, 200L); // 20L
																					// ~
																					// 1
																					// second
