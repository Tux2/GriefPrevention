...
public class WorldConfig {
	...
	private boolean config_eavesdrop; // whether whispered messages will be
										// visible to administrators

	private boolean config_eavesdrop_bookdrop;

	private ArrayList<String> config_eavesdrop_whisperCommands; // list of
																// whisper
																// commands to
																// eavesdrop on
	...
	private MaterialCollection config_mods_containerTrustIds; // list of block
																// IDs which
																// should
																// require
																// /containertrust
	...
	private MaterialCollection config_mods_explodableIds; // list of block IDs
															// which can be
															// destroyed by
															// explosions, even
															// in claimed areas
	...
	private List<String> config_mods_ignoreClaimsAccounts; // list of player
															// names which
															// ALWAYS ignore
															// claims

	private boolean config_pvp_allowCombatItemDrop; // whether a player can drop
	...
	private int config_pvp_combatTimeoutSeconds; // how long combat is
	...
	private boolean config_pvp_noCombatInAdminLandClaims; // whether players may
															// fight in
															// admin-owned land
															// claims

	private boolean config_pvp_noCombatInPlayerLandClaims; // whether players
															// may fight in
															// player-owned land
															// claims
