...
/**
 * holds configuration data global to GP as well as providing accessors to
 * retrieve/create configurations for individual worlds.
 * 
...
public class ConfigData {
	...
	/**
	 * returns the Configuration file location for the given world. Note that
	 * this file may or may not exist.
	 * 
	 * @param sName
	 *            Name of the world.
	 * @return the path name at which this configuration file will be found if
	 *         it exists.
	 */
	 ...
	 * 
	 * @param CoreConfig
	 *            Configuration (config.yml) source file that contains core
	 *            configuration information.
	 * @param outConfig
	 *            Target file to save back to.
	 */
